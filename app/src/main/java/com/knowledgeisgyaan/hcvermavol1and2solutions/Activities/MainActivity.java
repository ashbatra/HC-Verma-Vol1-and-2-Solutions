...
import com.knowledgeisgyaan.hcvermavol1and2solutions.Models.PreferencesManager;
import com.knowledgeisgyaan.hcvermavol1and2solutions.Models.ViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    int id = item.getItemId();
        ...
        String shareBody = "Hey! Check out this Offline app for HC Verma Solutions for Vol1 and Vol2 : " + strAppLink;

        String shareSub = "HC Verma Vol1 and 2 Solutions";
        ...
        startActivity(Intent.createChooser(intent4,"Share Using"));
            ...
            Toast.makeText(MainActivity.this,"Opening More Apps",Toast.LENGTH_SHORT).show();
        Intent intent5 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/developer?id=KnowledgeIsGyaan&hl=en"));
